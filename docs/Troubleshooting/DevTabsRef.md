...
=== "DEV:Info"    
    ...
    ![DEV:Info](img/CXAL.DTinfo.png){width=75%}
...
=== "DEV:Item States & Commands"    
    ...
    ![DevItemStates](img/CXAL.itemstates.png){width=75%}
...
=== "DEV: Category Mapping"  
    ...
    ![DEV:CatMap](img/CXAL.DTcatmap.png){width=75%}
...
=== "DEV: Camera Mapping"    
    ...
    ![DEV:CamMap](img/CXAL.DTcammap.png){width=75%}
...
=== "DEV: Live Events"
    ...
    ![DEV:LiveEvents](img/CXAL.DTliveevents.png){width=75%}
...
=== "DEV: Live State Changes"    
    ...
    ![DEV:LiveState](img/CXAL.DTlivestate.png){width=75%}
...
=== "DEV: Live Credential Holder Changes"
    ...
    ![DEV:LiveCreds](img/CXAL.DTlivecreds.png){width=75%}
***